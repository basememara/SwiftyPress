...
*/
SWIFT_CLASS("_TtC9RateLimit9RateLimit")
@interface RateLimit : NSObject
+ (BOOL)executeWithName:(NSString * _Nonnull)name limit:(NSTimeInterval)limit block:(SWIFT_NOESCAPE void (^ _Nonnull)(void))block;
+ (void)resetLimitForName:(NSString * _Nonnull)name;
+ (void)resetAllLimits;
